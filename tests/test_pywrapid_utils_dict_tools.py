...
def test_utils_dict_tools_dict_merge_1():
...
def test_utils_dict_tools_dict_merge_2():
...
def test_utils_dict_tools_dict_merge_3():
...
def test_utils_dict_tools_dict_keys_exist_5():
...
def test_utils_dict_tools_dict_keys_exist_6():
...
def test_utils_dict_tools_dict_keys_exist_7():
    """Test dict_keys_exist to raise on partial matches"""
    data = {"a": 1, "b": {"c": 2, "d": 3}, "e": []}
    expected_keys = ["a", "b", "e"]
    with pytest.raises(ValueError):
...
def test_utils_dict_tools_dict_keys_exist_8():
...
def test_utils_dict_tools_dict_keys_exist_9():
...
def test_utils_dict_tools_dict_keys_exist_10():
